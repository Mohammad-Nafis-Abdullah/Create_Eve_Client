      ...
      <div className="lg:py-20 bg-gray-100 ">
        <div className="grid lg:flex justify-center gap-x-6">
          ...
          <div className="lg:w-4/12 px-3 lg:px-0 py-10 lg:py-0">
            ...
            <p className="py-8">
              Create-Evedestination Management services include: tourism
              planning, transportation, PRIVATE security details, hotel
              accommodation, restaurants, activities, excursions, conference
              venues, themed events, gala dinners and logistics, meetings,
              incentive schemes as well as helping with overcoming language
              barriers. We utilize a structured tour model or a small group
              luxury tour model that is personal and catered to our corporate
              executives and dignitaries. All of our tours include welcome gifts
              and some of the most beloved souvenirs from the venues. To provide
              unparalleled event management solutions while providing our valued
              clients with a unique, customized experience that fully captures
              the essence of Wine Country. We also offer destination design
              services in the greater San Francisco-Bay Area upon request.
            </p>
              ...
              <div className="w-72 max-w-full bg-white cursor-pointer">
                ...
                <div className="-mt-5">
                  ...
                  <div className="text-gray-500">
                    <p className="mt-2">● {service.details.a}</p>
                    <p className="mt-2">● {service.details.b}</p>
                    <p className="mt-2">● {service.details.c}</p>
                    {service.details?.d && (
                      <p className="mt-2">● {service.details?.d}</p>
                    )}
                  </div>
