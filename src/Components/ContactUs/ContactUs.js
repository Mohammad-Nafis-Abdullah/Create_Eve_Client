...
import Address from "../About/AboutUs/Address";
    ...
    <div className="route">
      <div className=" p-3 bg-image lg:h-[340px] h-[200px] banner-background">
        ...
        <div className="flex justify-center items-center gap-x-3 lg:-mt-16 -mt-10 text-white ">
          <Link to="/" className="text-lg font-semibold" data-aos="fade-right">
            Home
          </Link>
          <span>|</span>
        ...
        <div className="container mx-auto">
          <div className="flex justify-around">
            <div className="grid justify-center">
              <p className="tracking-[6px] uppercase" data-aos="fade-right">
                Contact Us
              </p>
              <p className="text-5xl" data-aos="fade-left">
                <span>Keep In Touch </span>
                <span className="font-bold">With CREATE-EVE</span>
              </p>
            </div>

            <div
              className="flex flex-col lg:flex-row gap-x-3 gap-y-1.5 shadow-lg rounded-md px-3 pb-3 bg-white"
              data-aos="zoom-in-up"
            >
              <div className="text-highlight rounded-sm text-2xl bounce mt-0.5">
                <FiMail />
              </div>
              <div className="space-y-1">
                <h4 className="font-body text-xl">Have a question?</h4>
                <p className="text-paragraph">I am here to help you.</p>
                <p className="text-highlight font-normal">
                  Email us at create.eve@gmail.com
                </p>
              </div>
            </div>
          </div>
