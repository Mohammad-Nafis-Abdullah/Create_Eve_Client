...
function DisplayMyBooking({ booking, handleBookingCancle }) {
    ...
    return (
        <div className=" bg-no-repeat bg-center bg-cover rounded-lg overflow-hidden"
        ...
        >
            ...
            >
                <div className='z-10 text-white '>
                    <p>{date}</p>
                    <p className=" text-2xl openSans text-amber-500">{eventName}</p>
                    <p className="text-2xl openSans text-amber-500">Venue : {venueName}</p>
                    <p>{location}</p>
                </div>
                ...
                <div className='space-y-3 z-10'>
                    ...
                    {/* <div className="card-actions justify-end ">
                        <button onClick={() => handleBookingCancle(_id)} className="btn btn-error text-white">Cancle</button>
                    ...
                    <div className="flex justify-end gap-5 px-5 pt-5">

                        {
                            booking?.transactionId ?
                                ...
                                :
                                <>
                                    <button onClick={() => handleBookingCancle(_id)} className={`border-4 border-red-500 inline-block w-28 h-12 openSans uppercase tracking-wider transition-all text-red-500 font-extrabold hover:shadow-[0_0_35px_rgb(236,68,68)] hover:bg-red-500 hover:text-gray-900 text-lg duration-300`}>Cancel</button>
                                    <button onClick={() => navigate(`/dashboard/payment/${_id}`)} className={`border-4 border-sky-500 inline-block w-28 h-12 openSans uppercase tracking-wider transition-all text-sky-500 font-extrabold hover:shadow-[0_0_35px_rgb(14,165,233)] hover:bg-sky-500 hover:text-gray-900 text-lg duration-300`}>Pay</button>
                                </>
                        }
