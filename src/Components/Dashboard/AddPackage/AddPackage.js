...
const AddPackage = () => {
  ...
  // const {data: pkgs,loading: pkgLoading,refetch: pkgRefetch} = useRefetch(`http://localhost:5000/packages`, []);
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="pt-5 pb-3 text-xl font-bold text-center">
          Add a Package
        </h2>
        <div className="bg-white p-5 rounded-none sm:rounded-2xl max-h-fit mt-2 mb-12 max-w-lg mx-auto">
