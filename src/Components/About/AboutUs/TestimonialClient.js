    ...
    <div className=" mt-20">
      <div className="flex justify-center items-center h-full lg:-mt-8">
        <div className="text-gray-700 text-center">
          <p className="tracking-[8px] uppercase" data-aos="fade-right">
            Testimonials
          </p>
            ...
            <div key={index} className="mt-16 ">
              <div className="flex justify-center pb-12 ">
                <p className="text-6xl ">
                  <FaQuoteRight className="text-color" />
                </p>
              </div>
              <p className="px-10 text-center text-gray-600 font-semibold text-xl">
                “Bring people together, or turn your passion into a business.
                Harmoni gives you everything you need to host your best event
                yet. lorem ipsum diamet. Bring people together, or turn your
                passion into a business. Harmoni gives you everything you need
                to host your best event yet.”
              </p>
