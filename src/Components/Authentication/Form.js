...
import { errorMssg } from "../Prebuild/functions";
...
const Form = () => {
  ...
  const signIn = (e) => {
    ...
    signInUser && toast.success("Successfully Signed In");
  ...
  useEffect(() => {
    if (!err) {
      ...
      if (FacebookError) {
        console.log("FacebookError", FacebookError);
        setErr(FacebookError);
      }
    }
  }, [signUpError, signInError, googleError, FacebookError]);
  ...
  return (
    <section className={`${styleLg.bg}`}>
      ...
      <div className={`flex justify-center items-center p-3 route`}>
        {/* for large device */}
          ...
          >
            ...
            >
              ...
              <input
                ...
                name="pass"
              />
              <span className={`${styleLg.a} font-semibold`} href=" ">
        ...
        {/* for small device */}
        <div className={`${styleSm.main} sm:hidden`}>
          <input
            required
