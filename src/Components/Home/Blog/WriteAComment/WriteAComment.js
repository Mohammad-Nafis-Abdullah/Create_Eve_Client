...
const WriteAComment = ({ refetch, blogId }) => {
  ...
  const [userComment, , userCommentRefetch] = useRefetch(`/my-comment/${user?.uid + ':' + blogId}`)
        ...
        <form onSubmit={handleSubmit(handleAdddetail)}>
          ...
          <section className='flex gap-2'>
            ...
            <div className=" rating">
              <input onClick={countStars} type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" value={1}
                data-aos="fade-right"
                data-aos-delay="800"

              />
              <input onClick={countStars} type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" value={2}
                data-aos="fade-right"
                data-aos-delay="600"

              />
              <input onClick={countStars} type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" value={3}
                data-aos="fade-right"
                data-aos-delay="400"

              />
              <input onClick={countStars} type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" value={4}
                data-aos="fade-right"
                data-aos-delay="200"

              />
              <input onClick={countStars} type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" value={5}
                data-aos="fade-right"
