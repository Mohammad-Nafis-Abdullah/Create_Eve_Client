      ...
      <div className=" lg:max-w-7xl lg:mx-auto   lg:pt-20  ">
        <div className=" flex flex-col lg:max-w-7xl lg:mx-auto lg:gap-x-20   lg:flex-row   pb-20">
          <div className="  2xl:mx-auto  px-4 lg:px-20  md:px-6 ">
            ...
            <h2
              className=" font-semibold lg:text-[18px] text-3xl lg:ml-5 lg:leading-9 md:leading-7 leading-9 text-[#878787]">
              FIND YOUR ANSWER
            </h2>
            <h2
              className="mt-5 font-semibold lg:text-[48px] text-3xl lg:ml-5 lg:leading-9 md:leading-7 leading-9 text-gray-800">
              Ask & Questions
            </h2>
                ...
                <div className="lg:w-[420px]">
                  <div className=" flex justify-between items-center cursor-pointer">
                    <h3 className=" font-semibold text-xl leading-5 text-gray-800">
                      How to join Create-Eve Event Planner?
                    </h3>
                    <button
                      aria-label="too"
          ...
          <div className=" md:w-5/12 lg:w-1/2 w-full ">
            <div>
              ...
              <h2
                className="text-center lg:text-start lg:ml-5 font-semibold lg:text-[18px] text-3xl lg:leading-9 md:leading-7 leading-9 text-[#878787]">
                OUR BLOG
              </h2>
              <h2
                className="text-center mt-5 font-semibold lg:ml-5 lg:text-start lg:text-[48px] text-3xl lg:leading-9 md:leading-7 leading-9 text-gray-800">
                Latest News
              </h2>
            </div>
